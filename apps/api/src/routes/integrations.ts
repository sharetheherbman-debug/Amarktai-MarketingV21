...
const router = Router();
// Every integration resource belongs to one organization. Resolve and verify the
// requested tenant once at the boundary so no endpoint can trust a caller-supplied
// organization_id without membership being confirmed.
