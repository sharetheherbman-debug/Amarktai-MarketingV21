        ...
        <div className="flex h-16 shrink-0 items-center px-3">
          ...
          {sidebarOpen && (
            <Link href="/dashboard" onClick={closeOnMobile} className="ml-3 flex min-w-0 items-center gap-2.5">
              <img src="/logo.png" alt="EquiProfile" className="h-10 w-auto max-w-[118px] shrink-0 object-contain" />
              <div className="min-w-0 leading-tight">
                <p className="truncate text-[15px] font-semibold tracking-tight text-white">EquiProfile</p>
                <p className="truncate text-[10px] font-semibold uppercase tracking-[0.13em] text-white/45">Marketing</p>
              </div>
            </Link>
          )}
        </div>
          ...
          <div className={cn('flex items-center gap-3 rounded-lg px-1 py-1.5', !sidebarOpen && 'justify-center px-0')}>
            ...
            {sidebarOpen && (
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-1.5 truncate text-[11px] text-white/55">{currentOrganization?.name || 'EquiProfile Marketing'}</p>
              </div>
            )}
