  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#050505] px-4">
      ...
      <div className="relative z-10 max-w-lg text-center">
        <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-yellow-500/10 mx-auto">
          <svg
          ...
          >
            <path
              ...
              d="M11.42 15.17l-5.384 3.07A1.125 1.125 0 014.5 17.07V6.93c0-.69.448-1.31 1.122-1.475l5.384-1.538a1.125 1.125 0 011.008.226l5.494 4.727a1.125 1.125 0 01.226 1.008l-1.538 5.384a1.125 1.125 0 01-1.475.516z"
            />
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        <div className="mt-6 inline-flex items-center gap-2 rounded-full border border-yellow-500/20 bg-yellow-500/10 px-4 py-2">
          ...
          <span className="text-sm text-yellow-300">Maintenance in progress</span>
        </div>
        <p className="mt-4 text-sm text-zinc-500">
          Expected to be back by 2:00 PM UTC
        </p>
        <div className="mt-8 flex flex-col items-center gap-4">
          ...
          <div className="flex items-center gap-6">
            <a
              href="https://twitter.com/amarktai"
              target="_blank"
            ...
            <a
              href="https://linkedin.com/company/amarktai"
              target="_blank"
              rel="noopener noreferrer"
              className="text-zinc-500 transition-colors hover:text-white"
              aria-label="LinkedIn"
            ...
            <a
              href="https://github.com/amarktai"
              target="_blank"
              rel="noopener noreferrer"
              className="text-zinc-500 transition-colors hover:text-white"
              aria-label="GitHub"
